...
function titaniumPage() {
  return (
    <div className="bio">
  <h1 className="heading">Eigenschaften Titan</h1>
  <p>
    Titan ist ein chemisches Element mit dem Symbol Ti und der Ordnungszahl 22. Es ist ein Übergangsmetall, das in der Natur häufig in Verbindungen vorkommt und aufgrund seiner vielfältigen Eigenschaften breite Anwendung findet.
    <br />
    <br />
    ...
    Diese Eigenschaften machen Titan zu einem vielseitigen Material, das in einer Vielzahl von Branchen weit verbreitet ist. Es wird häufig in der Luft- und Raumfahrt, der Medizin, der Chemieindustrie, der Automobilindustrie und vielen anderen Bereichen eingesetzt.
  </p>
</div>
